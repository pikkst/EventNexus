-- ============================================
-- FIX: Revenue Functions to Use Correct Columns
-- Date: 2025-12-28
-- Purpose: Update functions after adding payment_status and price to tickets
-- ============================================
...
BEGIN
  ...
  LEFT JOIN public.tickets t ON t.event_id = e.id 
    AND t.status IN ('valid', 'used')  -- Only valid/used tickets
    AND t.payment_status = 'paid'      -- Only paid tickets
...
SELECT 'Testing get_organizer_revenue for free tier user...' as test;
SELECT * FROM get_organizer_revenue('aa5983cc-3889-43dc-a6dc-4eeb3db9805e');

SELECT 'Testing get_organizer_revenue_summary for free tier user...' as test;
SELECT * FROM get_organizer_revenue_summary('aa5983cc-3889-43dc-a6dc-4eeb3db9805e');
