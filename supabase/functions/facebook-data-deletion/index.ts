...
serve(async (req) => {
  ...
  if (req.method === 'POST') {
    try {
      ...
      console.log('🗑️ Facebook data deletion request:', JSON.stringify(body, null, 2))
      ...
      console.log('🗑️ Processing data deletion for Facebook user:', userId)
      
      // Delete all Facebook-related data
      // 1. Remove connection
      ...
      console.log('✅ Facebook data deleted successfully')
      
      // Generate unique confirmation code (required by Facebook)
