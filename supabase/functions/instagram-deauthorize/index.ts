...
serve(async (req) => {
  ...
  if (req.method === 'POST') {
    try {
      ...
      console.log('📤 Instagram deauthorization request:', JSON.stringify(body, null, 2))
      ...
      console.log('🔓 Deauthorizing Instagram user:', userId)
      ...
      console.log('✅ Instagram account deauthorized successfully')
      
      // Return confirmation URL (required by Instagram)
